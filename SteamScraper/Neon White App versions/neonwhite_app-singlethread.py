...
class NeonWhiteApp:
    ...
    def _build_ui(self):
        ...
        # Rush Tools placeholder frames — will be replaced when Rush Toolbox is built
        for key in ["rush_finder", "rush_parser", "rush_splits", "rush_std", "rush_timer"]:
            ...
            self._section_header(f, label_map[key], "Coming soon — Rush Tools integration.")
            tk.Label(f, text="This tool is under construction.",
                     font=("Helvetica", 11), bg=t["bg"], fg=t["fg2"],
                     padx=24, pady=12).pack(anchor="w")
            setattr(self, f"{key}_frame", f)

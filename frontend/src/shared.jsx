...
export const Icon = ({ name, size = 14 }) => {
  ...
  switch (name) {
    ...
    case "multicompare": return <svg viewBox="0 0 16 16" style={s}><g {...sp}><circle cx="3" cy="4" r="1.3"/><circle cx="13" cy="4" r="1.3"/><circle cx="8" cy="6.5" r="2.1"/><path d="M3 14c0-2.2 2.2-4 5-4s5 1.8 5 4"/></g></svg>;
